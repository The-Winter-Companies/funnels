            ...
            <fieldset><legend hidden="true">address</legend>
                ...
                <div class="form-cont">
                    <div class="form-group" id="street_address">
                        ...
                        <input id="address" class="form-control" name="address" type="text" data-geocomplete="street address" placeholder="Enter Street Address" required>
        ...
        <div class="row">
            ...
            <div class="col-sm-4 col-12 p-box">
                <div class="page-box">
                    ...
                    <p data-step="2">Instantly receive up to 4 free, no obligation quotes from our trusted network of installers.</p>
                </div>
            </div>
...
<section class="page-content imgbg solarbg">
    <div class="container">

        <div class="col-md-7 col-12 ml-auto">
            <h2 class="page-desc ml-0">About Us</h2>
            <p class="page-title ml-0">Find the most affordable Solar system for your home.</p>

            <p>Whether you are struggling to select the best Solar System, or you want to compare all the Solar deals available right now, we will help you tackle the situation.</p>
    ...
    $("form").validate({
        ...
        $(document).ready(function() {
            ...
            $.stepanimate = function () {
                ...
                var progressPercentage = ((current_step-24) / (totalStep)) * 98;
