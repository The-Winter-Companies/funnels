...
<main>
    ...
    <article class="container">
        ...
        <div class="content">
            <p>This Forever Home Hub General Privacy Policy (“Privacy Policy”) covers the information we collect about you both online and offline, including information that you provide to us online or that we collect when you interact with Forever Home Hub, Inc. and its subsidiaries, brands, and affiliates (collectively, “Forever Home Hub”) websites, the Mobile Services (as defined below) or desktop application services, software, or other materials or services made available on, from, or through the websites (collectively, the “Website(s)”). Some sections of this Privacy Policy may be specific to certain Forever Home Hub affiliates, subsidiaries, or grouped companies only. Where that occurs, we will inform you.
            ...
            <p>Forever Home Hub Website(s) are not intended for and should not be used by anyone under the age of eighteen (18). To use the Website(s) or provide information to Forever Home Hub, you must either be (a) at least eighteen (18) years of age or the age of majority in your jurisdiction of residence (whichever is greater); or, (b) if you are between the ages of thirteen (13) and eighteen (18)/the age of majority, you must have the consent of your legal parent or guardian to use the Website(s). If you are under thirteen (13) years of age, please do not use the Website(s). If we learn we have collected or received personal information from a child under thirteen (13) without verification of parental or guardian consent, we will delete that information. If you believe we might have any information from or about a child under thirteen (13), please contact us at info@foreverhomehub.com.<br><br>
            ...
            <p>Forever Home Hub may collect and receive customer data and other personal information and data (“personal information”) in a variety of ways. Forever Home Hub collects, generates, and/or receives personal information, including (i) identifying information provided through your account, (ii) contact information, (iii) survey results and information, (iv) payment, billing, or financial information, (v) usage information, (vi) cookie information, (vii) information from third party services and partners, and (viii) additional information provided to Forever Home Hub through User Submissions.
            <br><br>
                Forever Home Hub may receive this information directly from you, for example from forms you fill out; indirectly from you, for example by observing your behaviors or interactions with our Website(s); or from third parties, such as our business partners, clients, or enrichment services.<br><br>
                Forever Home Hub is the controller of the personal information collected on the Website(s), which includes:<br><br>
                ...
                Some registered customers of Forever Home Hub subscription services use the services to collect information about how their own users use the services, applications, websites and related third-party applications, including personal information (“Forever Home Hub Services Data”).<br><br>
                With respect to Forever Home Hub Services Data, please note: <br><br>
                <b>1.</b> Forever Home Hub Services Data may include, without limitation, information about the identity of Forever Home Hub users (such as name, postal address, e-mail address, IP address and phone number), as well as information about the pages users visit, the features they use, and the actions they take while using the Fixel services.<br>
                <b>2.</b> This Privacy Policy does not apply to Forever Home Hub Services Data and we are not responsible for our clients’ handling of Forever Home Hub Services Data. Our clients have their own policies regarding the collection, use and disclosure of your personal information. To learn about how a particular client handles your personal information, we encourage you to read the client’s privacy statement.<br>
                <b>3.</b> Fixel may collect, process, and use anonymized client end user data.
            </p>
            <h4>User Submissions</h4>
            <p>
                “User Submissions” are communications between you and Forever Home Hub. For example, Forever Home Hub may send you emails related to the Website(s) (e.g., for account verification, changes/updates to features of the Website(s), technical and security notices). Forever Home Hub may collect personal information through User Submissions to respond to your inquires. Note that you may not opt out of these emails without deleting your account.<br><br>
                You may opt out of our email newsletters by clicking the “Unsubscribe” at the bottom of each email and following the subsequent instructions. You may also opt-out of all marketing and advertising communications from Forever Home Hub by contacting us using the contact information below or emailing us at info@foreverhomehub.com.<br><br>
                Forever Home Hub may offer certain services that are available via a mobile device or app, including (i) the ability to provide User Submissions to the Website(s) via a mobile device, and (ii) the ability to browse the Website(s) from a mobile device (collectively, the ”Mobile Services“). If you use the Mobile Services, Forever Home Hub may store information regarding your mobile device, including your device type and operating system, the advertising ID of your mobile device, location services, or in other applications as permitted by the functionality of such mobile device.<br><br>
                In addition, Forever Home Hub may access, collect, monitor, store on your device, and/or remotely store one or more “device identifiers.” Device identifiers are small data files or similar data structures stored on or associated with your mobile device, which uniquely identify your mobile device. A device identifier may be data stored in connection with the device hardware, data stored in connection with the device’s operating system or other software, or data sent to the device by Forever Home Hub. A device identifier may deliver information to Forever Home Hub or to a third party partner about how you browse and use the Website(s) and may help Forever Home Hub or others provide reports or personalized content and ads. Some features of the Website(s) may not function properly if use or availability of device identifiers is impaired or disabled.
            </p>
            <h4>Enrichment Services</h4>
            <p>
                Certain categories of personal information may be made available to our customers and business partners in connection with providing data enrichment services. Data enrichment is a process of combining data from different sources to enhance, refine, and improve the data. Forever Home Hub may combine data in its possession, or with data from enrichment services, in order to match contact data or other relevant records linked to the same individual. Data that may be returned by our enrichment services include email addresses, social handles, hashed identifiers, basic demographic information, and consumer interests.<br><br>
            ...
            <p>
                ...
                Forever Home Hub may share User Submissions and your information (including but not limited to, information from cookies, log files, device identifiers, location data, and usage data) with businesses that are legally part of the same group of companies that Forever Home Hub is part of, or that become part of that group (“Affiliates”). Affiliates may use this information to help provide, understand, and improve the Website(s) (including by providing analytics) and Affiliates’ own services (including by providing you with better and more relevant experiences); however, these Affiliates will honor the choices you make about who can see your photos.<br><br>
                Forever Home Hub may also share personal information outlined in this Privacy Policy, with others, in the following instances:<br><br>
            ...
            <p>
                Forever Home Hub may need to disclose personal information when required by law or legal process. Forever Home Hub may also share information when it has a good-faith belief that such action is necessary: to comply with a current judicial proceeding, a court order or legal process served on Forever Home Hub or any of its Affiliates; to prevent fraud or other illegal activity; to prevent imminent bodily harm; or, to protect Forever Home Hub and users from people violating this Privacy Policy or Terms of Use.
            </p>
            <h4>Business Transitions</h4>
            <p>
                In the event Forever Home Hub goes through a business transition, such as a merger, acquisition by another company, or sale of a portion of its assets, or if Forever Home Hub declares bankruptcy, Forever Home Hub may transfer your personal information as part of the assets transferred.
            </p>
            <h4>Data Retention</h4>
            <p>
                Forever Home Hub will retain your personal information for as long as is necessary to fulfill the services that you have requested, comply with any laws or regulations, resolve disputes, and enforce our agreements. Forever Home Hub may retain your data longer for a legitimate business interest where the business benefit is not outweighed by your personal rights and freedoms.
            </p>
            <h4>Links</h4>
            <p>The Website(s) contain links to third party sites. Please be aware that Forever Home Hub has no control over and is not responsible for the privacy practices or content of such other sites. We encourage our users to be aware when they leave our site and to read the privacy statements of each and every website that collects personally identifiable information. This privacy statement applies solely to information collected by Forever Home Hub.</p>
            ...
            <p>Whenever Forever Home Hub changes its Privacy Policy, we will post those changes to the Website(s), this privacy statement, and other places we deem appropriate.</p>
            <h4>Violations of this Policy</h4>
            <p>Forever Home Hub will terminate your access to the Website(s) if, under appropriate circumstances, Forever Home Hub determines you violated this Privacy Policy or the Terms of Use.</p>
            <h4 id="ccpa">California Consumer Privacy Rights</h4>
            <p>YOUR PRIVACY RIGHTS – California law permits California residents to request certain information regarding collection, uses, sharing of, and deletion of personal information internally and to third parties. Under the CCPA, this is your ‘Right to Know’, ‘Right to Request Deletion’, ‘Right to Opt-Out of Sale’, and ‘Right to be Free from Discrimination’. To make a verifiable consumer request pursuant to the CCPA, please send an email to info@foreverhomehub.com or fill out the request form here.
            <br><br>
                A consumer request is considered verifiable by email address. For example, a verifiable request submitted by email must be received by or confirmed through the email address associated with the personal information in question. An authorized agent must contact info@foreverhomehub.com to submit a request under the CCPA on a California consumer’s behalf and must carbon copy (CC:) the email address in question in the request. We may request additional information to verify the request or the agent<br><br>
            ...
            <br><br>
                ...
                Forever Home Hub collects this Personal Information directly and indirectly from California residents themselves and from third parties such as enrichment services, joint marketing, co-branding, co-promotional, or advertising partners; Affiliates; and other sources of demographic information.<br><br>
                In the preceding twelve (12) months, Forever Home Hub has disclosed the following categories of personal information for a business purpose:<br><br>
                <b>1.</b> Name, phone number, street address, city, zip code, email address, household income, or financial and payment information, date of birth, age, gender, political views, vehicle(s), service or utility provider(s), and homeowner status, relationship or marital status, etc.;<br>
                <b>2.</b> Identifiers such as IP address and other network information, online identifiers, cookie IDs and similar information, mobile device IDs, advertising IDs, device information and characteristics, and browser or device “fingerprint”—not your personal fingerprint but instead a statistical classification of your device or browser;<br>
                <b>3.</b> Survey responses (where voluntarily provided);<br>
                <b>4.</b> Transaction information and purchase history;<br>
                ...
                <b>7.</b> Form submissions and Emails; and<br>
                <b>8.</b> Inferences drawn from any of the Personal Information listed above to create a profile or summary about, for example, an individual’s preferences and characteristics.<br><br>
                In the preceding twelve (12) months, Forever Home Hub has sold the following categories of personal information:<br><br>
                <b>1.</b> Name, phone number, street address, city, zip code, email address, household income, or financial and payment information, date of birth, age, gender, political views, vehicle(s), service or utility provider(s), and homeowner status, relationship or marital status, etc.;<br>
                <b>2.</b> Identifiers such as IP address and other network information, online identifiers, cookie IDs and similar information, mobile device IDs, advertising IDs, device information and characteristics, and browser or device “fingerprint”—not your personal fingerprint but instead a statistical classification of your device or browser;<br>
                <b>3.</b> Survey responses (where voluntarily provided);<br>
                <b>4.</b> Transaction information and purchase history;<br>
                ...
                <b>7.</b> Form submissions and Emails; and<br>
                <b>8.</b> Inferences drawn from any of the Personal Information listed above to create a profile or summary about, for example, an individual’s preferences and characteristics.<br><br>
                In some instances, you may have the opportunity to provide personal information for a price quote or service. You can opt into these services by submitting your personal information. If you subsequently wish to withdraw your consent, you can do so by a verifiable consumer request by sending an email to info@foreverhomehub.com or by filling out the request form here.
            </p>
            ...
            <p>If you are 16 years of age or older, you have the right to direct us to not sell your personal information at any time (the “Right to Opt-Out”). We do not sell the personal information of consumers we actually know are less than 16 years of age. Individuals who opt-in to personal information sales may opt-out of future sales at any time.<br><br>
                To exercise the right to opt-out, you (or your authorized representative) may submit a request to us by visiting the following Internet Web page link: https://foreverhomehub.com/contact<br><br>
            ...
            <p>
                California’s “Shine the Light” law (Civil Code Section § 1798.83) permits users of our Website(s) that are California residents to request certain information regarding our disclosure of personal information to third parties for their direct marketing purposes. To make such a request, please send an email to info@foreverhomehub.com.
            </p>
            <h4>Contact Information</h4>
            <p>
                If you have inquiries about our privacy practices or you suspect that Forever Home Hub has handled your information in a manner that does not comply with this Privacy Policy, please contact us by emailing to info@foreverhomehub.com.<br><br>
