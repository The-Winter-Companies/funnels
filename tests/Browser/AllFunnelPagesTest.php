...
class AllFunnelPagesTest extends DuskTestCase
{
    ...
    public function testNormalFlow(): void
    {
        ...
        // WINTERBOT FAIL TESTS

        // Roofing F1 test

        $this->browse(function (Browser $browser) {
            $browser
                ->visit('/roofing/f1?ef_tx_id=x&ef_aff_id=y&ef_offer_id=z&testParam=true')
                ->assertSee('Where would this project take place?')
                ->type("#zip_code", "55442")
                ->click("#btn-zip")
                ->pause(2000)
        ...
        $this->browse(function (Browser $browser) {
            $browser
                ->visit('/roofing/o7?ef_tx_id=x&ef_aff_id=y&ef_offer_id=z&testParam=true')
                ->assertSee('Find Top-Rated Roofing Pros And Save!')
                ->type("#zip_code", "55442")
                ->click("#btn-zip")
                ->pause(2000)
        ...
        $this->browse(function (Browser $browser) {
            $browser
                ->visit('/roofing?ef_tx_id=x&ef_aff_id=y&ef_offer_id=z&testParam=true')
                ->pause(2000)
                ->assertSee('Check How Much You Can Save')
                ->type("#zip_code", "55442")
                ->click("#btn-zip")
        ...
        $this->browse(function (Browser $browser) {
            $browser
                ->visit('/solar/?ef_tx_id=x&ef_aff_id=y&ef_offer_id=z&testParam=true')
                ->assertSee('Enter your zip code')
                ->type("zip_code", "55442")
                ->click("#btn-zip")
                ->pause(1000)
        ...
        $this->browse(function (Browser $browser) {
            $browser
                ->visit('/solar/o7?ef_tx_id=x&ef_aff_id=y&ef_offer_id=z&testParam=true')
                ->assertSee('Solar')
                ->assertSee('Are you a homeowner?')
                ->click("#pc01")
                ->pause(1000)
        ...
        $this->browse(function (Browser $browser) {
            $browser
                ->visit('/solar/f1?ef_tx_id=x&ef_aff_id=y&ef_offer_id=z&testParam=true')
                ->assertSee('Where would this project take place?')
                ->type("zip_code", "55442")
                ->click("#btn-zip")
                ->pause(1000)
        ...
        $this->browse(function (Browser $browser) {
            $browser
                ->visit('/tubs/?ef_tx_id=x&ef_aff_id=y&ef_offer_id=z&testParam=true')
                ->assertSee('Enter your zip code')
                ->type("zip_code", "55442")
                ->click("#btn-zip")
                ->pause(2000)
        ...
        $this->browse(function (Browser $browser) {
            $browser
                ->visit('/tubs/f1?ef_tx_id=x&ef_aff_id=y&ef_offer_id=z&testParam=true')
                ->assertSee('Where would this project take place?')
                ->type("zip_code", "55442")
                ->click("#btn-zip")
                ->pause(2000)
        ...
        $this->browse(function (Browser $browser) {
            $browser
                ->visit('/tubs/o7?ef_tx_id=x&ef_aff_id=y&ef_offer_id=z&testParam=true')
                ->assertSee('What is your zip code?')
                ->type("zip_code", "55442")
                ->click("#btn-zip")
                ->pause(2000)
